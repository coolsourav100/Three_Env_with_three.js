...
const Navbar = () => {
  ...
  return (
    ...
    <Link to='/' className='flex items-center gap-2' onClick={()=>{
      window.scrollTo(0,0)
      setActive('')}}><img src={logo} alt='logo' className='w-9 h-9 object-contain'/>
      <p className='text-white text-[18px] font-bold cursor-pointer flex'>Sourav |<span className='sm:block hidden'>3D Modeling</span></p>
      </Link>
